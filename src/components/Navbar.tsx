...
const Navbar = () => {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-[padding,background-color,backdrop-filter] duration-500 ease-[cubic-bezier(0.25,0.4,0.25,1)] ${scrolled ? 'glass-strong py-3' : 'py-5'}`}
    >
